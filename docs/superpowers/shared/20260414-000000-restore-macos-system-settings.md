...
**Files:**
- Create: `config/system/macos/system-settings-shared.conf`
- Create: `scripts/system/macos/system-configure`
- Test: `tests/system/macos/test-system-config.sh`

- [ ] **Step 1: Write failing shape tests for the restored system feature**
- [ ] **Step 2: Run `tests/system/macos/test-system-config.sh` and verify it fails**
- [ ] **Step 3: Restore the config file and standalone script without the old logging hooks**
- [ ] **Step 4: Re-run `tests/system/macos/test-system-config.sh` and verify it passes**

### Task 2: Restore Runtime Coverage

**Files:**
- Create: `tests/system/macos/test-system-runtime.sh`
...
- [ ] **Step 2: Run `tests/system/macos/test-system-runtime.sh` and verify it fails**
- [ ] **Step 3: Adjust the restored script only as needed to satisfy the runtime contract**
- [ ] **Step 4: Re-run `tests/system/macos/test-system-runtime.sh` and verify it passes**

### Task 3: Restore User-Facing Docs And Suite Wiring

**Files:**
- Create: `docs/system/macos/system.md`
- Modify: `README.md`
- Modify: `tests/shared/shared/test-docs.sh`
- Modify: `tests/shared/shared/test-help.sh`
- Modify: `tests/shared/shared/test-args.sh`
...
**Files:**
- Verify: `tests/shared/shared/test-all.sh`

- [ ] **Step 1: Run `tests/shared/shared/test-all.sh`**
