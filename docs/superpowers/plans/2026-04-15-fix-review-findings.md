...
**Tech Stack:** Bash shell scripts, config files under `config/`, Markdown documentation, shell-based runtime tests under `tests/macos/`
...
**Files:**
- Modify: `config/caddy/shared-macos.Caddyfile`
- Modify: `scripts/macos/caddy-configure`
- Modify: `tests/macos/test-caddy-config.sh`
- Modify: `tests/macos/test-caddy-runtime.sh`

- [ ] **Step 1: Write the failing tests**

```bash
grep -q '^https://127.0.0.1:8123 {$' tests/macos/test-caddy-config.sh
grep -q 'first-run custom prefix without pre-created etc' tests/macos/test-caddy-runtime.sh
```

- [ ] **Step 2: Run tests to verify they fail**

Run: `./tests/macos/test-caddy-config.sh && ./tests/macos/test-caddy-runtime.sh`
...
```bash
git add config/caddy/shared-macos.Caddyfile scripts/macos/caddy-configure tests/macos/test-caddy-config.sh tests/macos/test-caddy-runtime.sh
...
**Files:**
- Modify: `scripts/macos/caddy-trust`
- Modify: `tests/macos/test-caddy-trust-runtime.sh`
- Modify: `README.md`
- Modify: `docs/macos/caddy.md`

- [ ] **Step 1: Write the failing tests**

```bash
grep -q 'stale certificate name is not enough' tests/macos/test-caddy-trust-runtime.sh
grep -q 'https://127.0.0.1:8123' docs/macos/caddy.md
```

- [ ] **Step 2: Run tests to verify they fail**

Run: `./tests/macos/test-caddy-trust-runtime.sh && ./tests/macos/test-docs.sh`
...
```bash
git add scripts/macos/caddy-trust tests/macos/test-caddy-trust-runtime.sh README.md docs/macos/caddy.md
...
**Files:**
- Modify: `scripts/macos/podman-configure`
- Modify: `tests/macos/test-podman-machine-runtime.sh`
- Modify: `docs/macos/podman.md`

- [ ] **Step 1: Write the failing tests**

```bash
grep -q 'unchanged machine matches 8192 memory and 60 disk' tests/macos/test-podman-machine-runtime.sh
grep -q 'PODMAN_MACHINE_NAME_DEFAULT' docs/macos/podman.md
```

- [ ] **Step 2: Run tests to verify they fail**

Run: `./tests/macos/test-podman-machine-runtime.sh && ./tests/macos/test-docs.sh`
...
```bash
git add scripts/macos/podman-configure tests/macos/test-podman-machine-runtime.sh docs/macos/podman.md
...
**Files:**
- Modify: `scripts/macos/podman-check`
- Modify: `tests/macos/test-podman-diagnose-runtime.sh`
- Modify: `tests/macos/test-podman.sh`
- Modify: `lib/shell/common.sh`

- [ ] **Step 1: Write the failing tests**

```bash
grep -q 'safe_log_host_name' tests/macos/test-podman-diagnose-runtime.sh
grep -q 'integration skipped unconditionally' tests/macos/test-podman.sh
```

- [ ] **Step 2: Run tests to verify they fail**

Run: `./tests/macos/test-podman-diagnose-runtime.sh && ./tests/macos/test-podman.sh`
...
```bash
git add scripts/macos/podman-check tests/macos/test-podman-diagnose-runtime.sh tests/macos/test-podman.sh lib/shell/common.sh
...
**Files:**
- Modify: `scripts/macos/system-configure`
- Modify: `tests/macos/test-all.sh`
- Modify: `tests/macos/test-help.sh`
- Modify: `README.md`
- Modify: `docs/macos/system.md`

- [ ] **Step 1: Write the failing tests**

```bash
grep -q 'test-help.sh' tests/macos/test-all.sh
grep -q '^if is_help_flag "\${1-}"; then$' scripts/macos/system-configure
```

- [ ] **Step 2: Run tests to verify they fail**

Run: `./tests/macos/test-help.sh && ./tests/macos/test-all.sh`
...
```bash
git add scripts/macos/system-configure tests/macos/test-all.sh tests/macos/test-help.sh README.md docs/macos/system.md
...
Run: `./tests/macos/test-caddy-config.sh && ./tests/macos/test-caddy-runtime.sh && ./tests/macos/test-caddy-trust-runtime.sh && ./tests/macos/test-podman-machine-runtime.sh && ./tests/macos/test-podman-diagnose-runtime.sh && ./tests/macos/test-podman.sh && ./tests/macos/test-help.sh && ./tests/macos/test-docs.sh`
Expected: PASS.

- [ ] **Step 2: Run full verification**

Run: `./tests/macos/test-all.sh`
Expected: PASS with `All macOS checks passed`.

- [ ] **Step 3: Commit**

```bash
git add README.md docs/macos/caddy.md docs/macos/podman.md docs/macos/system.md
