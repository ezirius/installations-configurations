...
test_active_files_are_documented() {
  ...
  assert_contains "$ROOT/tests/shared/brew/test-brew-install.sh" 'This test covers:' 'active test header should describe covered behaviors'
  assert_contains "$ROOT/tests/shared/downloads/test-macos-download.sh" 'This test covers:' 'active macos download test header should describe covered behaviors'
