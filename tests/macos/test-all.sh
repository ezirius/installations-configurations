...
bash -n \
  ...
  tests/macos/test-brew-configure-runtime.sh \
  tests/macos/test-brew-service.sh \
  tests/macos/test-brew-service-runtime.sh \
  ...
  tests/macos/test-caddy-override-runtime.sh \
  ...
  tests/macos/test-podman-check-runtime.sh \
  tests/macos/test-podman-diagnose-runtime.sh \
...
"$ROOT/tests/macos/test-brew-configure-runtime.sh"
"$ROOT/tests/macos/test-brew-service.sh"
"$ROOT/tests/macos/test-brew-service-runtime.sh"
...
"$ROOT/tests/macos/test-caddy-override-runtime.sh"
...
"$ROOT/tests/macos/test-podman-check-runtime.sh"
"$ROOT/tests/macos/test-podman-diagnose-runtime.sh"
