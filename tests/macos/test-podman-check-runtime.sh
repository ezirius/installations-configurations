...
SCRIPT_FILE="$ROOT/scripts/macos/podman-check"
...
assert_contains "$STATE_DIR/missing.err" 'scripts/macos/brew-bootstrap' 'podman-check reports the current bootstrap command clearly'
