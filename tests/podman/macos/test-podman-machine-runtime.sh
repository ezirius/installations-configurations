...
mkdir -p "$REPO_DIR/scripts/podman/macos" "$REPO_DIR/lib/shell/shared" "$REPO_DIR/config/podman/macos" "$REPO_DIR/config/repo/shared"
cp "$ROOT/scripts/podman/macos/podman-configure" "$REPO_DIR/scripts/podman/macos/podman-configure"
...
cp "$ROOT/lib/shell/shared/machine-config.sh" "$REPO_DIR/lib/shell/shared/machine-config.sh"
